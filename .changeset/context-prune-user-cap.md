...
- The tail-prune safety net never returns an empty message list, so a lone oversized latest message (e.g. an image whose base64 exceeds the cap) can never reproduce the empty/malformed request.
